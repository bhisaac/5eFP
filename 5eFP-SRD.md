...
The Five Energies Focus Practice (5eFP) is a tabletop role-playing game (TRPG) that combines fun and immersive gameplay with deepening levels of self-exploration. 5eFP can be played for fun, self-reflection, mindfulness, or combine any of the three. 5eFP's dedication and inspiration rules are system-agnostic and can be used with any TRPG.
