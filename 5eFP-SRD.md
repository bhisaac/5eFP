...
4. **Not just another TRPG.** 5eFP GMs hold the center for all players within their practice, requiring cultivated skills and capacities that demand resources and energy to sustain. 5eFP Game Masters (GMs) are selective about participants. Ideal candidates are individuals with emotional and social intelligence who are curious about themselves and others, and who join the practice for personal growth and self-awareness. Other reasons for joining are not accepted, and all admission fees are non-refundable.
