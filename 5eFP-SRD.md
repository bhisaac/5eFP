...
2. **Collaboration and Trust.** GMs and player characters (PCs) collaborate to create an enjoyable narrative that holds meaning and significance for the group and each player. Story elements spontaneously arise during gameplay, with GMs generating ideas while PCs contribute to the narrative. Trust and collaboration are essential to transform 5eFP from a purely escapist activity for enjoyment into a mindful group exploration with the power to heal and transform our individual experience. Players and GMs must want to understand and support one another while maintaining healthy personal boundaries to get anything out of the practice. 5eFP GMs excel at storytelling while providing the underlying game structure needed to keep the game's story engaging and consistent without needing to control or pressure the other players.
...
4. **Not just another TRPG.** 5eFP GMs hold the center for all players within their practice, requiring cultivated skills and capacities that demand resources and energy to sustain. They are selective about participants. Ideal candidates are individuals with emotional and social intelligence who are curious about themselves and others and join the practice out of a desire for personal growth and self-awareness. Other reasons for joining are not accepted, and all admission fees are non-refundable.
5. **Guidance.** 5eFP guides players with existing counselors, therapists, teachers, and guides. Players are strongly encouraged to seek help with self-reflection and mindfulness guides. Without an objective observer to provide feedback, we easily fall into self-deception and denial. We often become blinded by our insecurities and shortcomings, making it difficult to overcome or release old patterns that no longer serve us without the support of a coach, teacher, or guide. The content generated during 5eFP sessions can serve as material for discussion with these guides, who can also suggest suitable gameplay explorations. One goal of 5eFP is to foster these collaborative relationships.
