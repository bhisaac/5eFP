...
1. **Consent in gaming.** 5eFP uses consent in gaming to promote a safe space for players to explore themselves through the characters they play and the game world their characters interact with. Infighting, backstabbing, or disharmonious behavior between GMs and payers is prohibited.
...
2. **Collaboration and Trust.** Game Masters (GMs) and player characters (PCs) collaborate to create an enjoyable narrative that holds meaning and significance for the group and each player. Story elements spontaneously arise during gameplay, with GMs generating ideas while PCs also contribute. Trust and collaboration are essential to transform 5eFP from a purely escapist activity for enjoyment into a mindful group exploration with the power to heal and transform our individual experience. Players and GMs must want to understand and support one another to get anything out of the practice. 5eFP GMs excel at storytelling, providing structure and guiding decisions to keep the story engaging and consistent without controlling or applying pressure toward the other player's game experience.
3. **No compulsion.** 5eFP is an at-will TRPG where you can join or leave practices freely, without coercion. Rejoining is not allowed once you leave a practice, but you can join a different one. Benefits are gained only from active participation. These games foster a pressure-free environment for self-reflection and personal growth.
4. **Not just another TRPG.** 5eFP GMs hold the center for all players within their practice, requiring cultivated skills and capacities that demand resources and energy to sustain. Any admission fees related to joining a 5eFP practice are non-refundable.
5. **Guidance.** 5eFP guides players with existing counselors, therapists, teachers, and guides. Players are strongly recommended to ally with self-reflection and mindfulness guides, as humans often fall into self-deceit. The content generated during 5eFP sessions can serve as material for discussion with these guides, who can also suggest suitable gameplay explorations. One goal of 5eFP is to foster these collaborative relationships.
