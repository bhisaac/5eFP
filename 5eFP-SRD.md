...
3. **No compulsion.** 5eFP is an at-will tabletop role-playing game (TRPG) where you can join or leave practices freely, without coercion. Rejoining is not allowed once you leave a practice, but you can join a different one. Benefits are gained only from active participation. These games foster a pressure-free environment for self-reflection and personal growth, and your Game Master (GM) and fellow players cannot control your game experience.
