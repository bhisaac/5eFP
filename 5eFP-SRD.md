...
Read about the changes from the SRD 5.1 to 5eFP-SRD at [https://github.com/bhisaac/5eFP/discussions/5#discussion-8485918](https://github.com/bhisaac/5eFP/discussions/5#discussion-8485918).
...
|Cost|Prerequisites|Feature|Details|
|-:|:-:|:-|:-|
|4⛁|-|-|If the creature misses, you can make one melee attack against it.|
...
- **Research.** Spend ⛁ and choose one from a creature, item, location, lore, or restricted or otherwise unavailable game feature. Add the chosen research to the list of available HQ research. By default, research requires 5⛁ to complete. Any player may contribute to the cost of completing research during their turn. Some research may require additional Coin to complete as indicated within its description. When creature research is completed, PCs can read that creature's stat block. Completing research on a restricted game feature upgrades the practice's gameplay, unlocking the feature and making it playable. For example, Gnome can be added as a playable species. When other forms of research are complete, the PCs decide what is learned, revealing one new piece of information about the nature of the research subject. If it is determined that more than one piece of information can be gained through research, the PCs must begin and complete new research for each additional piece of information.
...
**Thrash.** The awakened shrub boss deals slashing damage to adjacent foes. A successful DEX check reduces the damage by half.
...
1. 5eFP uses consent in gaming to help promote a safe space for players to self-reflect through the characters they play and the game world their characters interact with.
    ...
    * The most recent release can be found at [Monty Cook Games](https://www.montecookgames.com/consent-in-gaming/) and [DriveThruRPG](https://www.drivethrurpg.com/en/product/288535/consent-in-gaming?term=consent%20in)
...
- Celestials, demons, and devils were removed from the core game rules. They can be added back in through a campaign setting handbook. Iconic fantasy creatures like the unicorn, pegasus, and couatl are intelligent and magical beasts.
    - Two reasons for this change.
        ...
        - Reduces system bloat (fewer monster types) and prevents the 5eFP game engine from getting consumed by the fires of good and evil, law and chaos. These can be found in the setting handbook if they are present in the game world.
...
- AC changes to Defense (10 + DEX) and the protection provided through shields and light, medium, and heavy armor.
    - The defense score represents how well you evade attacks, whereas armor and shields reduce assigned damage and wounds. Taken together, they form the essence of what AC represents in 5e.
...
- Game features have acquired a number of keywords:
    ...
    - **Rest.** A feature with the rest keyword is reset and replenished when completing a rest. If a number follows the rest keyword, it represents the number of times you can use this feature, but no more than once per turn.
...
- Spells are simplified into seven levels, directly corresponding to character level for the spellcasting classes (bard, cleric, druid, sorcerer, warlock, wizard). Paladin and Ranger, and certain class archetypes like the fighter's eldritch knight, unlock spell levels much slower, as explained in their game features.
...
- Barbarian changes
    - Rage changes from a cooldown X feature to an encounter feature that can only be used during combat and trap encounters (where it's used 100% of the time anyway). No need to keep track of how many times you've used it. It's now always accessible at least once per encounter. This makes it less like bookkeeping to track how often you use the feature. And it doesn't end early if you haven't attacked or taken damage since your last turn (this was an attempt to narrow its focus to combat or dangerous situations--it's now mitigated by requiring a combat or trap encounter).
- Warlock changes
