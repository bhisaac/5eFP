...
**_Turn_.** During a round, a creature takes its turn, during which it can spend a wide variety of actions. Usually, over the course of one turn, a creature can take an action, use an object, or take a reaction (see Actions). A game feature with the turn keyword is only accessible during your turn and activates once. Any bonuses or penalties it provides remain in effect until the beginning of your next turn. A feature with the turn keyword regains the ability to activate at the start of your turn.
...
A clear crystal sphere about the size of a marble, with a smooth, glossy surface. Embedded within the transparent exterior is a mesmerizing swirl of mist that shifts and flows like a living cloud. Tiny flecks of silver occasionally sparkle within the mist.
...
A group of 4th-level PCs deploy onto a previously explored level 1 world map tile, travelling to a previously explored dungeon on the map. The last time they were here, another group discovered a rope leading up through a hole in the floor. At 1st level, the group couldn't face 4th-level encounters and, thus, couldn't climb the rope. The group is now 4th level and chooses to climb the rope. The group then finds themselves on a level 4 (1 [ground floor] + 3) floor of the dungeon. Then, on the level 4 floor, the PCs discover a staircase leading up. The group pauses again. The new floor at the top of the staircase is a level 7 (4 [the current floor level] + 3) floor! Since the group is level 4, they cannot enter a 7th-level floor. Later, they find another hole with a rope leading down. Since they are finished exploring the level 4 floor, they decide to climb down the rope and find themselves back on the level 1 floor in a previously unexplored area of the map.
...
1. 5eFP uses consent in gaming to help promote a safe space for players to self-reflect through the characters they play and the game world their characters interact with.
    * Get _Consent in Gaming_ for free at [Monty Cook Games](https://www.montecookgames.com/consent-in-gaming/) and [DriveThruRPG](https://www.drivethrurpg.com/en/product/288535/consent-in-gaming?term=consent%20in)
