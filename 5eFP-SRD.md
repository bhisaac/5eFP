...
3. **No compulsion.** 5eFP is an at-will TRPG in which you are personally invested and free to join or leave without coercion. Once you leave a practice, you cannot later rejoin it, but you can join a different 5eFP practice. You will only gain benefits from the 5eFP practices in which you actively participate. 5eFP provides a pressure-free space for self-reflection and personal growth during gameplay. Collaboration is encouraged, but the GM and other players cannot control your experience.
