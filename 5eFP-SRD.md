...
>>>
>>> **_Astral Form._** You have 2 + LEVEL MAX wounds while in astral form. You may use Wild Shape as a bonus action when shapeshifting into astral form. When you choose this form, you do not assume the shape of a beast. You remain in your normal form while gaining a number of additional features. You become translucent, taking on an indigo tint filled with points of moving lights.
