...
An exact copy of this service agreement must be included within any product or service using any part of the 5eFP system reference document (SRD) https://github.com/bhisaac/5eFP/blob/main/5eFP-SRD.md
