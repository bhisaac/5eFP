...
2. **Collaboration and Trust.** GMs and player characters (PCs) collaborate to create a meaningful narrative during gameplay. Story elements arise spontaneously, with GMs generating ideas while PCs contribute. Trust and collaboration heal and transform individual player experiences. GMs and players seek to understand each other while maintaining healthy boundaries established with consent in gaming. 5eFP GMs excel at storytelling and provide a game structure that engages the narrative with a neutral and balanced atmosphere free of compulsion and cruelty.
