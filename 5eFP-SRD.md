...
5. **Guidance.** 5eFP is designed to work with players who have preestablished counselors, therapists, teachers, and guides. While players can learn and grow by themselves, it is strongly recommended that they seek out and ally with one or more of these guides if they use 5eFP primarily as a self-reflective and mindful practice. The content they create in 5eFP sessions can provide material to explore with their guide. Guides can also suggest well-suited explorations to explore during a 5eFP game session. One of the goals of 5eFP is to encourage this kind of collaborative relationship.
