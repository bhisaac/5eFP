...
2. **Collaboration and Trust.** Game Masters (GMs) and player characters (PCs) collaborate to create an enjoyable narrative that holds meaning and significance for the group and each individual player. Story elements spontaneously arise during gameplay, with GMs generating ideas while PCs also contribute. Trust and collaboration are essential to transform a TRPG game from a purely escapist activity into a mindful group exploration. Players and GMs must want to understand and support one another in order to get anything out of the practice. 5eFP GMs excel at storytelling, providing structure and guiding decisions to keep the story engaging and consistent without controlling or applying pressure toward the other player's game experience.
