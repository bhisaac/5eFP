...
7. **_One GM: One practice_.** A 5eFP game has one designated GM dedicated to the practice. A 5eFP GM may create a new practice once an existing practice is completed or ends. A 5eFP practice ends before completion if the number of active players drops below eight.
