...
1. **Consent in gaming.** 5eFP uses consent in gaming to promote a safe space for players to explore themselves through the characters they play and the game world their characters interact with. Infighting, backstabbing, or disharmonious behavior between payers is prohibited.
    * [Consent in Gaming PDF](https://github.com/bhisaac/5eFP/blob/dcc548a4b9a3fa14b2f1def8178ae63fabcd1738/Consent_in_Gaming-2019-09-13.pdf) 2019.09.13 release
    * [Form Fillable Checklist PDF](https://github.com/bhisaac/5eFP/blob/dcc548a4b9a3fa14b2f1def8178ae63fabcd1738/Consent%20in%20Gaming-Form%20Fillable%20Checklist-2019-09-13.pdf) 2019.09.13 release
...
4. **Not just another TRPG.** 5eFP Game Masters (GMs) hold the center for all players within a practice, requiring cultivated skills and capacities that demand time, resources, and energy to sustain. Therefore, any financial prerequisites for joining a 5eFP practice are nonrefundable.
5. **Guidance.** 5eFP is designed to offer guidance and work with players who have preestablished counselors, therapists, teachers, and guides. While players can learn and grow by themselves, it is strongly recommended that they seek out and ally with one or more of these guides if they use 5eFP primarily as a self-reflective and mindful practice. The content they create in 5eFP sessions can provide something to reflect upon with their guide. Guides can also suggest well-suited explorations to experience during a 5eFP game session. One of the goals of 5eFP is to encourage these kinds of collaborative relationships.
6. **Therapeutic but _not therapy_.** 5eFP games can often have a therapeutic effect. These games can bring aspects and parts of us that were once hidden to the surface. All 5eFP players are encouraged to support one another when this happens. If such an emergence occurs, you are encouraged to make a brief journal or note about the experience so you can remember it after the game session. _You save it for later because 5eFP games are not therapy_. _We do not stop the game and process what's arising for you_. Like in real life, all players must integrate spontaneously and adapt as these experiences arise. You can ask for a short break if you need more time to journal. There is extra time at the end of a game session specifically for journaling as well. And there will be plenty of time to process later with a guide or teacher.
