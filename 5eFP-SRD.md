...
**a.** **Private Use Exceptions.** The content ratings presented below are required whenever 5eFP is shared with the general public. While highly recommended, these guidelines are not requirements for GMs who run unpublished homebrew campaigns or for GMs hosting private 5eFP games.
