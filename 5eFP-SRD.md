...
**a.** **Private Use.** Tge content ratings presented below are required whenever 5eFP is shared with the general public. These guidelines are not requirements for GMs who run unpublished homebrew campaigns or for GMs hosting private 5eFP games.
