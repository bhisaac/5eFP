...
3. **No compulsion.** 5eFP is an at-will TRPG where you can join or leave practices freely, without compulsion. Rejoining a practice after being asked to leave or voluntarily leaving is not allowed, but you can join a different one. Benefits are gained only from active participation. These games foster a pressure-free environment for self-reflection and personal growth.
...
- (196) 2x2 black obscuring map tiles with the following modifications
    - (40) are marked with hybrid orbs or circles (all colors separated into four quadrants)
